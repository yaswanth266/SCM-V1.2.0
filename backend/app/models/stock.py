from sqlalchemy import Column, BigInteger, String, DateTime, Enum, ForeignKey, Numeric, Time, Index, UniqueConstraint, JSON
...
class VehicleStockBalance(Base):
    __tablename__ = "vehicle_stock_balance"
    ...
    __table_args__ = (
        Index("idx_vsb_vehicle", "vehicle_code"),
        Index("idx_vsb_item", "item_id"),
        UniqueConstraint("vehicle_code", "item_id", "batch_id", name="uq_vehicle_stock_balance_key"),
    )


class VehicleStockLedger(Base):
    __tablename__ = "vehicle_stock_ledger"
    ...
    __table_args__ = (
        Index("idx_vsl_vehicle", "vehicle_code"),
        Index("idx_vsl_item", "item_id"),
        Index("idx_vsl_wh", "warehouse_id"),
        Index("idx_vsl_date", "posting_date"),
        Index("idx_vsl_ref", "reference_type", "reference_id"),
    )
