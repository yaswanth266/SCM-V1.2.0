...
export const MENU_CONFIG = [
  ...
  },
  {
    ...
    children: [
      ...
      { key: 'procurement-quotations', label: 'Quotations', path: '/procurement/quotations' },
  ...
  },
  {
    ...
    icon: 'CarOutlined',
    children: [
      { key: 'logistics-transport-requirements', label: 'Transport Requirements', path: '/logistics/transport-requirements' },
      { key: 'logistics-vendor-quotations', label: 'Vendor Quotations', path: '/logistics/vendor-quotations' },
      { key: 'logistics-transport-orders', label: 'Transport Orders', path: '/logistics/transport-orders' },
      { key: 'logistics-shipment-tracking', label: 'Shipment Tracking', path: '/logistics/shipment-tracking' },
      { key: 'logistics-fleet-dashboard', label: 'Fleet Dashboard', path: '/logistics/fleet-dashboard' },
    ],
  },
  {
    key: 'indent',
  ...
  },
  {
    ...
    children: [
      ...
      { key: 'reports-logistics', label: 'Logistics', path: '/reports/logistics' },
